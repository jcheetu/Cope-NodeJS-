...
JavaScriptCode.setAttribute("src", 'http://localhost:1337/js/cope_dialogueflow/copeWidget/allchat.js');
...
window.onload = function() {
    $( "#generic-chat-container" ).chat({
        ...
        ai : document.getElementById('generic-chat-container').getAttribute("chatbot-ai")
    }); 
};
